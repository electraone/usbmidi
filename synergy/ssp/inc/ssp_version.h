...
#define SSP_VERSION_STRING                  ("2.2.0")

/** Unique SSP version ID. */
#define SSP_VERSION_BUILD_STRING            ("Built with Renesas Synergy (TM) Software Package version 2.2.0+build.cb5551e5e518668eaf555d160c9049a989ab0f2a")
